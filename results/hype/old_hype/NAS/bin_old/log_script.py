...
palavras = ['Run time = ','Time:','Energy:','CO2eq:','km travelled by car', 'Run time without initialization =','Execution Time','___Execucao_com','Execution time', 'Elapsed time','Time in seconds =']
