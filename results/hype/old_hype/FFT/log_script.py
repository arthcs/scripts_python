...
def process_data(file_path):
    ...
    for line in lines:
        ...
        elif "Execucao_com" in line and "Treads" in line:
...
palavras = ['Run time = ','Time:','Energy:','CO2eq:','km travelled by car', 'Run time without initialization =','Execution Time','___Execucao_com']
