...
for iter in 1566 # 2 4 6 8 10 12 24
do
	unset OMP_GERAS
	export OMP_NUM_THREADS=$iter
	../../../../utils/count_freq.sh >> out/freq.$iter.txt &	
	../../../../utils/count_temp.sh >> out/temp.$iter.txt &	

	./srad 4096 4096 0 127 0 127 $iter 0.5 400 > out/$iter.txt
