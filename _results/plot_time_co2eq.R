plot_co2 <- plot_grid(blaise_plot_co2[['out_bt.C.x']],blaise_plot_co2[['out_cg.C.x']],blaise_plot_co2[['out_ft.C.x']],blaise_plot_co2[['out_mg.C.x']],blaise_plot_co2[['out_sp.C.x']],blaise_plot_co2[['out_ua.C.x']],
                       ncol = 3,
