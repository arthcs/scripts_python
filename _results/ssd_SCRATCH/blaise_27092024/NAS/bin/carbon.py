...
nas_application = sys.argv[2] #nome da aplicação
log_dir = './carbon_out/'
...
tracker = CarbonTracker(
        ...
        verbose=1,
        log_dir=str(log_dir),
        log_file_prefix=str(nas_application)+'_'+str(threads_num)+'T',
        ignore_errors=True
)
...
for epoch in range(max_epochs):
    ...
    #os.system('OMP_NUM_THREADS=20 ./bt.C.x')
    os.system('OMP_NUM_THREADS='+str(threads_num)+' ./'+str(nas_application))
    tracker.epoch_end()
